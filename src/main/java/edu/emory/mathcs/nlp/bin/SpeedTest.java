...
import edu.emory.mathcs.nlp.component.dep.DEPAccuracyEval;
 ...
 */
public class SpeedTest<N extends NLPNode, L extends String,S extends NLPState<N,L>>
{
    ...
    public SpeedTest(String[] args) throws Exception
    {
        ...
        NLPComponent<N, L,S> component = (NLPComponent<N,L,S>)obj.readObject();
        obj.close();
        ...
        component.setEval(new DEPAccuracyEval(true));
        while ((nodes = reader.next()) != null)
        {
            speed.measure(nodes);
            if (out != null) out.println(Joiner.join(nodes, "\n", startIndex(nodes))+"\n");
        }
        System.out.println("Test score is: " + component.getEval().scores());
    ...
    {
        return (TSVIndex<N>)new DEPIndex(1, 2, 3, 4, 7, 8);
    }
